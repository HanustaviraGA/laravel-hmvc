...
<html lang="en">
	<!--begin::Head-->
	<head><base href="">
		<title id="ttl">Laravel - <?= $ucf ?></title>
			...
			<div class="page d-flex flex-row flex-column-fluid">
				...
				<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
					...
					<div class="aside-logo flex-column-auto" id="kt_aside_logo" style="background-color: #ffffff; justify-content: center;">
						<!--begin::Logo-->
						<a href="/" data-navigo>
							<img alt="Logo" src="{{ asset('assets/media/logos/logo-laravel.png') }}" class="h-40px logo" />
						</a>
						<!--end::Logo-->
						<!--begin::Aside toggler-->
						...
						<div class="container-fluid d-flex align-items-stretch justify-content-between">
							...
							<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
								<a href="../../demo1/dist/index.html" class="d-lg-none">
									<img alt="Logo" src="{{ asset('assets/media/logos/logo-laravel.png') }}" class="h-30px" />
								</a>
							</div>
							<!--end::Mobile logo-->
							<!--begin::Wrapper-->
												...
												<div class="menu-item px-3">
													<div class="menu-content d-flex align-items-center px-3">
														...
														<div class="symbol symbol-50px me-5">
															{{-- <img alt="Logo" src="dashboard/assets/media/avatars/150-26.jpg" /> --}}
					...
					<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a href="{{ url('/') }}" target="_blank" class="text-gray-800 text-hover-primary">Laravel</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Menu-->
